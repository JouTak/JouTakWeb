const Contact = () => {
    return (
        ...
        >
            ...
            <div className="container pt-5 text-white position-relative" style={{ zIndex: 2 }}>
                <h1 className="display-5 fw-bold">Наши сообщества</h1>
                <p className="col-md-10 fs-4 lh-1">
                    Подпишись, чтобы быть в курсе новостей Джоутека, <br></br>ИТМОкрафта и майнкрафта!
                </p>
                <div className="d-flex justify-content-center gap-3 my-4">
                    ...
                    >
                        <img src="/img/icons/tg.svg" alt="Telegram" className="social-icon"/>
                    </a>
                    <a
                    ...
                    >
                        <img src="/img/icons/discord.svg" alt="Discord" className="social-icon"/>
                    </a>
                </div>
                <div className="container position-relative d-flex justify-content-end mt-3">
                    <a
                        className="btn btn-primary btn-lg"
                        href="https://joutak.ru/joutak"
                    >
