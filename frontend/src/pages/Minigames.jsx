      ...
      <div className="text-center">
        ...
        <div className="container py-3">
          ...
          <p className="col-md-8 fs-4 lh-1 mx-auto">
            Мини-игры стали неотъемлемой частью Minecraft, и наш сервер приглашает вас окунуться в мир
            соревнований на спартакиаде от{" "}
            <a href="https://vk.com/kb_esports" target="_blank" rel="noopener noreferrer">
              Кронверскских барсов
            </a>.
            Здесь вас ждут проверенные классические режимы, разработанные с нуля от наших разработчиков:<br></br> <b>Block
            Party, Ace Race, UHC</b>.
          </p>
